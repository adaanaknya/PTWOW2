 ...
 * @author Yoggg
 */
public class TabelDaftarVendor extends javax.swing.JFrame {

    /**
     * Creates new form DataProduk
     */
    public TabelDaftarVendor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Vendor ", "Nama Vendor", "No Telepon", "Email", "Alamat", "Edit ", "Hapus"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelDaftarVendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelDaftarVendor().setVisible(true);
            }
        });
    }
