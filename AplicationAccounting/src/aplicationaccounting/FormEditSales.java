 ...
 * @author Yoggg
 */
public class FormEditSales extends javax.swing.JFrame {

    /**
     * Creates new form DataProduk
     */
    public FormEditSales() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditSales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditSales().setVisible(true);
            }
        });
    }
